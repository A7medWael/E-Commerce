...
namespace MyShop.Web.Migrations
{
    ...
    [Migration("20240206160624_AddOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("myshop.Entities.Models.OrderHearder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("myshop.Entities.Models.OrderDetails", b =>
                {
                    b.HasOne("myshop.Entities.Models.OrderHearder", "orderHearder")
                        .WithMany()
            ...
            modelBuilder.Entity("myshop.Entities.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("myshop.Entities.Models.Product", "products")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
